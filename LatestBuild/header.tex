...
\usepackage{svg}
\usepackage{hyperref} % Creates Hyperlinks for references
...
% -----------------------------------------------------------------------------------
\newcommand{\AssignmentTitle}{Understanding Competitive Positioning Within the MTC and its use to Develop a Marketing Strategy}
\newcommand{\ModuleTitle}{Industrial Critique Report}
